...
def display_instances_tempVR(image_name, image, boxes, masks, class_ids, class_names,
                      scores=None, title="",
                      figsize=(16, 16), ax=None):
    """
    boxes: [num_instance, (y1, x1, y2, x2, class_id)] in image coordinates.
    ...
    ax.imshow(masked_image.astype(np.uint8))
    # TODO Remove this
    save_img_path = "/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/pytorch_mask_rcnn_2/temp_results/%s.jpg"%image_name

...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    # TODO Remove this
    save_img_path = "/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/pytorch_mask_rcnn_old/deleteme_masked_image.jpg"
    print("Saving image to %s. TODO Disable this feature."%(save_img_path))
    #cv2.imwrite(save_img_path, cv2.cvtColor(masked_image.astype(np.uint8), cv2.COLOR_BGR2RGB))

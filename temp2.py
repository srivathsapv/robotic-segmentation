...
import os
from pytorch_mask_rcnn.pycocotools import mask
from pytorch_mask_rcnn.pycocotools.cocostuffhelper import cocoSegmentationToPng
from pytorch_mask_rcnn.pycocotools.coco import COCO
import skimage.io
...
def cocoSegmentationToPngDemo(dataDir='../..', dataTypeAnn='train2017', dataTypeRes='examples', \
    ...
    if isAnnotation:
        ...
        """
    annPath = '/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/data/temp_masks/binary.json'  # TODO Revisit this
    if isAnnotation:
        pngFolder = '/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/data/temp_masks/binary_recovered'
    else:
        pngFolder = '/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/data/temp_masks/binary_recovered'
        resPath = '/Users/vishalrao/PycharmProjects/DeepLearning/robot-surgery-segmentation/data/temp_masks/binary.json'
...
if __name__ == "__main__":
    cocoSegmentationToPngDemo(isAnnotation=False)